...
BOT_USERNAME = getenv("BOT_USERNAME" , "Varmar_sarkarbot")

# Get Your repo
REPO_LINK = getenv("REPO_LINK" , "https://te.legra.ph/file/4b225214f22ad8bbc8a86.mp4")

# Don't Add style font 
BOT_NAME = getenv("BOT_NAME" , "Varmar_sarkarbot")
...
OWNER_ID = int(getenv("OWNER_ID", 6931603826))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Kartiknishad36/VERMASARKARMUSICBOT",
)
...
SUPPORT_CHANNEL = (getenv("SUPPORT_CHANNEL", "https://t.me/varmasarkarr"))
